...
But where will be the _private field_ be stored? This is a question for specialists in [`mixin` and `traits`](https://boris.unibe.ch/104671/1/Nier05eFlatteningTraitsTR.pdf).
