...
P.S. `primitive1Add_` was used as test subject, it performed on _smi_ 3 with _smi_ 4, using [arithmetic with overflow checking](https://gcc.gnu.org/onlinedocs/gcc/Integer-Overflow-Builtins.html), testing the (`stdcall` with oop receiver) calling convention.
